            ...
            try {
                ...
                if(sqlException!=null && sqlException.getSQLState()!=null &&
                    ...
                    log.error("Caught unique constraint exception with sql state: {} "+
                                    "in RestaurantApprovalRequestKafkaListener for order id: {}",sqlException.getSQLState(),
                    ...
                    throw new RestaurantApplicationServiceException("Throwing DataAccessException in "+
                            "RestaurantApprovalRequestKafkaListener: "+e.getMessage());
                }
            }catch(RestaurantNotFoundException e){
                log.error("No payment found for restaurant id: {} order id: {}",
