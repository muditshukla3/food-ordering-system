...
public class PaymentMessagingDataMapper {
    ...
    public PaymentResponseAvroModel
        paymentCancelledToPaymentResponseAvroModel(PaymentCancelledEvent paymentCancelledEvent){
        return PaymentResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
    ...
    public PaymentResponseAvroModel
        paymentFailedToPaymentResponseAvroModel(PaymentFailedEvent paymentFailedEvent){
        return PaymentResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
