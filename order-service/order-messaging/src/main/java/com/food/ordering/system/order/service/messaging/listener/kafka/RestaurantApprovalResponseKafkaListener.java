...
import com.food.ordering.system.order.service.ports.input.message.listener.restaurant.RestaurantApprovalResponseMessageListener;
            ...
            try {
                if (OrderApprovalStatus.APPROVED ==
                    ...
                    restaurantApprovalResponseMessageListener
                            .orderApproved(orderMessagingDataMapper
                ...
                // No-OP for optimistic lock. This means another thread finished the work, do not throw error tp prevent reading
                // the data from kafka again!
