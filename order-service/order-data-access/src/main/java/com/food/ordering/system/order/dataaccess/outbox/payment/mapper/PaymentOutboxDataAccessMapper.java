package com.food.ordering.system.order.dataaccess.outbox.payment.mapper;
...
public class PaymentOutboxDataAccessMapper {
    ...
    public OrderPaymentOutboxMessage paymentOutboxEntityToPaymentOutboxMessage(PaymentOutboxEntity
                                                                                  paymentOutboxEntity){
